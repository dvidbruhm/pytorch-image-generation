...
class CGANTrainer():
    def __init__(self, save_path=SAVE_PATH, beta1=BETA1, beta2=BETA2, 
        ...
        # Models
        self.generator = Generator(latent_input, model_complexity, dropout_prob, weights_mean, weights_std, image_channels, num_labels, image_size).to(self.device)
        self.discriminator = Discriminator(model_complexity, weights_mean, weights_std, packing, image_channels, num_labels, image_size).to(self.device)
